...
Il faut donc trouver un outil qui permet de transformer des fragments de LaTeX en HTML, directement dans le navigateur. Latex.js\footnote{\url{https://latex.js.org/}} est un traducteur de LaTeX en HTML qui répond à ces critères.\par
