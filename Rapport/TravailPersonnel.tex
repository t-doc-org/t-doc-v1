...
LaTeX est un langage qui permet de faire du formatage de nombreuses manières différentes, mais cela le rend très complexe et difficile à rendre compatible avec toutes les fonctionnalités. Make4ht fait appel à différents outils lors du processus de conversion, notamment TeX4ht. Lors de l'installation des packages TeX Live\footnote{\url{https://www.tug.org/texlive/}} pour la création du conteneur Docker, t-doc ne fonctionnait plus. Il a été compliqué de comprendre pourquoi. Les problèmes suivants ont été découverts:
\begin{itemize}
...
ALPINE LINUX DEVELOPMENT TEAM «Alpine Linux», 2024.\\
...
NIST «National Vulnerability Database», 2023.\\
...
STEPHEN CHECKOWAY; HOVAV SHACHAM; ERIC RESCORLA «Don't take LaTeX files from strangers», 2010.\\
<\url{https://www.usenix.org/system/files/login/articles/73506-checkoway.pdf}>.

TEX USERS GROUP «TeX Live», 2024.\\
<\url{https://www.tug.org/texlive/}>.

TEX USERS GROUP «TeX4ht», 2022.\\
