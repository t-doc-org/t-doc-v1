...
Par défaut, la taille de la fenêtre Geogebra est 100\% de la largeur de la page, afin d’optimiser l’utilisation pour l’élève. Il est possible de changer la dimension en ajoutant un paramètre optionnel, celui-ci doit être noté entre crochets et avant la référence du document Geogebra.\par
